  ...
  return (
    <section id="contact" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
            <CardHeader>
                <CardTitle className="font-headline text-lg">Información de Contacto</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm">
                <p className="text-muted-foreground">Disponible para oportunidades como Scrum Master / QA con enfoque técnico.</p>
                ...
                <a href="https://www.linkedin.com/in/anabel-chura-trivino" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                    ...
                    <span>/in/anabel-chura-trivino</span>
                </a>
        ...
        <Card>
            <CardHeader>
                <CardTitle className="font-headline text-lg">Detalles Adicionales</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-muted-foreground">
                <p><strong>Ubicación:</strong> Santa Cruz, Bolivia</p>
                <p><strong>Idiomas:</strong> Español (nativo), Inglés (B2)</p>
                <p><strong>Disponibilidad:</strong> Remoto o híbrido</p>
            </CardContent>
        </Card>
      </div>
    </section>
